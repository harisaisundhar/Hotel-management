...
$sql = "select no_of_clothes from laundry where type='cotton' and r_id in(SELECT a.r_id FROM register a, meals b WHERE a.nationality = b.cuisine and a.r_id=b.r_id)";
...
$result = $conn->query($sql);
			...
			while ($row = $result->fetch_assoc()) {
					$no_of_clothes=$row["no_of_clothes"];
					echo "Output : ";
					echo $no_of_clothes; echo "<br>";
}
